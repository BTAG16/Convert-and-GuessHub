...
function CurrencyConverterPage(){
  ...
  const t_1=(t.h.push(EventQ2(t.k, "convertaction", () => t.i, () => {
    ...
    Start(Delay(() => {
      const amount=_1.Get();
      const fromCurrency=_2.Get().toUpperCase();
      const toCurrency=_3.Get().toUpperCase();
      const _9=null;
      return Bind_1(Delay(() => {
        let o;
        let o_1;
        ...
        if(_10[0]&&_11[0]){
          const fromRate=exchangeRates.Item(fromCurrency.toUpperCase());
          return Return(Some(amount*(exchangeRates.Item(toCurrency.toUpperCase())/fromRate)));
        }
